...
<div class="row ">
	<div class="col-xs-12">
		...
		<table class="table table-bordered table-no-top-cell-border table-slim">
			<thead>
				<tr style="color: #000000 !important; font-weight: bold;" class="table-no-side-cell-border table-no-top-cell-border text-center">
					<td style="color: #000000 !important;">#</td>

					<td style="color: #000000 !important;" class="text-left" width="30%">
						{!! $receipt_details->table_product_label !!}
					</td>

					@if($receipt_details->show_cat_code == 1)
						<td style="color: #000000 !important;" class="text-right">{!! $receipt_details->cat_code_label !!}</td>
					@endif

					<td style="color: #000000 !important;" class="text-right">
						{!! $receipt_details->table_qty_label !!}
					</td>
					<td style="color: #000000 !important;" class="text-right">
						{!! $receipt_details->table_unit_price_label !!} <span class="small"> ({{$receipt_details->currency['symbol']}})</span>
					</td>
					...
					@if(!empty($receipt_details->table_tax_headings))
						...
						@foreach($receipt_details->table_tax_headings as $tax_heading)
							<td style="color: #000000 !important;" class="word-wrap text-right">
								{{$tax_heading}} <span class="small"> ({{$receipt_details->currency['symbol']}})</span>
							</td>
			...
			<tbody>
				...
				<tr>
					...
					@if(!empty($receipt_details->table_tax_headings))
					@foreach($receipt_details->table_tax_headings as $tax_heading)
						<th class="text-right" style="color: #000000 !important;">
							<span class="display_currency" data-currency_symbol="false">
							{{$totals[$tax_heading]}}
							</span>
						</th>
	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="color: #000000 !important;" class="font-23 padding-10">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-23 padding-10" style="color: #000000 !important;">
