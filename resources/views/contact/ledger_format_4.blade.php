	...
	<table class="table @if(!empty($for_pdf)) table-pdf td-border @endif" id="ledger_table">
		<thead>
			<tr class="row-border blue-heading">
				<th width="33%" class="text-center">@lang('lang_v1.date')</th>
				...
				<th width="8%" class="text-left">@lang('P S')</th>
				{{--<th width="10%" class="text-center">@lang('sale.total')</th>--}}
				<th width="17%" class="text-right">@lang('account.debit')</th>
				<th width="17%" class="text-right">@lang('account.credit')</th>
				<th width="18%" class="text-right">@lang('lang_v1.balance')</th>
				<th width="8%" class="text-center">@lang('P M')</th>
